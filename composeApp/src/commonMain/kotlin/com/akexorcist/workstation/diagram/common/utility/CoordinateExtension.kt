...
fun WorkstationCoordinates.getAllDeviceRect(): List<DeviceCoordinate.Device> = listOfNotNull(
    ...
    this.gamingConsole1.device,
    this.gamingConsole2.device,
    this.usbDockingStation.device,
    this.hdmiSwitcher.device,
...
private fun WorkstationCoordinates.getAllConnectors(): List<DeviceCoordinate.Connector> {
    return listOf(
        ...
        this.gamingConsole1.connectors,
        this.gamingConsole2.connectors,
        this.usbDockingStation.connectors,
        this.hdmiSwitcher.connectors,
